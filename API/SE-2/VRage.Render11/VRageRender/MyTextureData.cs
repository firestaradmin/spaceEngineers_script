...
>>>>>>> d46cf8619665219cc163a7b28984ced59ed9470d
		...
		private static void Save(IResource res, Stream stream, MyImage.FileFormat fileFormat)
		{
			...
			Save(srcPitch: MyImmediateRC.RC.MapSubresource(texture2D2, 0, 0, MapMode.Read, SharpDX.Direct3D11.MapFlags.None, out var stream2).RowPitch, format: format, stream: stream, fileFormat: fileFormat, dataPointer: stream2.DataPointer, size: res.Size);
