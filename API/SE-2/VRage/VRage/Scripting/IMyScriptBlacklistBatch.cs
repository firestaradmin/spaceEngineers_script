...
namespace VRage.Scripting
{
	...
	public interface IMyScriptBlacklistBatch : IDisposable
	{
		...
		/// <summary>
		///     Removes namespaces previously added with <see cref="M:VRage.Scripting.IMyScriptBlacklistBatch.AddNamespaceOfTypes(System.Type[])" /> from the blacklist.
		/// </summary>
		/// <param name="types"></param>
		...
		/// <summary>
		///     Removes types previously added with <see cref="M:VRage.Scripting.IMyScriptBlacklistBatch.AddTypes(System.Type[])" /> from the blacklist.
		/// </summary>
		/// <param name="types"></param>
		...
		/// <summary>
		///     Removes types previously added with <see cref="M:VRage.Scripting.IMyScriptBlacklistBatch.AddMembers(System.Type,System.String[])" /> to the blacklist.
		/// </summary>
		/// <param name="type"></param>
		/// <param name="memberNames"></param>
