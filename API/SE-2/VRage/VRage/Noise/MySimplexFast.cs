...
namespace VRage.Noise
{
	public class MySimplexFast : MyModuleFast
	{
		...
		public override int Seed
		{
			get
			{
				return m_seedSimplex;
			}
			set
			{
				m_seedSimplex = value;
				MyRNG myRNG = new MyRNG(m_seedSimplex);
				for (int i = 0; i < 256; i++)
				{
					m_permSimplex[i] = (byte)myRNG.NextIntRange(0f, 255f);
					m_permSimplex[256 + i] = m_permSimplex[i];
					m_gradSimplex[i] = (byte)((int)m_permSimplex[i] % 12);
		...
		public override double GetValue(double x)
		{
			...
			double num7 = num4 * num4 * Dot(grad3[m_gradSimplex[num & 0xFF]], num2);
			double num8 = num6 * num6 * Dot(grad3[m_gradSimplex[(num + 1) & 0xFF]], num3);
		...
		public override double GetValue(double x, double y)
		{
			...
			{
				num15 *= num15;
				num18 = num15 * num15 * Dot(grad3[m_gradSimplex[(num13 + m_permSimplex[num14]) & 0xFF]], num5, num6);
			}
			double num19;
			if (num16 < 0.0)
			{
			...
			{
				num16 *= num16;
				num19 = num16 * num16 * Dot(grad3[m_gradSimplex[(num13 + num7 + m_permSimplex[(num14 + num8) & 0xFF]) & 0xFF]], num9, num10);
			}
			double num20;
			if (num17 < 0.0)
			{
			...
			{
				num17 *= num17;
				num20 = num17 * num17 * Dot(grad3[m_gradSimplex[(num13 + 1 + m_permSimplex[(num14 + 1) & 0xFF]) & 0xFF]], num11, num12);
			}
		...
		public override double GetValue(double x, double y, double z)
		{
			...
			double num18 = num6 - (double)num12 + 0.33333333333333343;
			double num19 = num7 - (double)num13 + 0.33333333333333343;
			double num20 = num8 - (double)num14 + 0.33333333333333343;
			...
			{
				num27 *= num27;
				num31 = num27 * num27 * Dot(grad3[m_gradSimplex[num24 + m_permSimplex[num25 + m_permSimplex[num26]]]], num6, num7, num8);
			}
			double num32;
			if (num28 < 0.0)
			{
			...
			{
				num28 *= num28;
				num32 = num28 * num28 * Dot(grad3[m_gradSimplex[num24 + num9 + m_permSimplex[num25 + num10 + m_permSimplex[num26 + num11]]]], num15, num16, num17);
			}
			double num33;
			if (num29 < 0.0)
			{
			...
			{
				num29 *= num29;
				num33 = num29 * num29 * Dot(grad3[m_gradSimplex[num24 + num12 + m_permSimplex[num25 + num13 + m_permSimplex[num26 + num14]]]], num18, num19, num20);
			}
			double num34;
			if (num30 < 0.0)
			{
			...
			{
				num30 *= num30;
				num34 = num30 * num30 * Dot(grad3[m_gradSimplex[num24 + 1 + m_permSimplex[num25 + 1 + m_permSimplex[num26 + 1]]]], num21, num22, num23);
			}
