...
namespace VRage.Noise
{
	public class MyRidgedMultifractalFast : MyModuleFast
	{
		...
		public MyRidgedMultifractalFast(MyNoiseQuality quality = MyNoiseQuality.Standard, int layerCount = 6, int seed = 0, double frequency = 1.0, double gain = 2.0, double lacunarity = 2.0, double offset = 1.0)
		{
			Quality = quality;
