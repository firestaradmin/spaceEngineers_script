...
{
	internal class MyFlightAlternativeBindingScheme : IMyControlsBindingScheme
	{
		...
		private void CreateForBase()
		{
			...
			MyControllerHelper.AddControl(cX_BASE, MyControlsSpace.LOOKAROUND, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, pressed: false);
			MyControllerHelper.AddControl(cX_BASE, MyControlsSpace.CAMERA_ZOOM_IN, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.Yneg, pressed: true);
			MyControllerHelper.AddControl(cX_BASE, MyControlsSpace.CAMERA_ZOOM_OUT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.Ypos, pressed: true);
		...
		private void CreateForCharacter(bool invertYAxisCharacter, bool invertYAxisJetpackVehicle)
		{
			...
			MyControllerHelper.AddControl(cX_CHARACTER, MyControlsSpace.FAKE_RB_LS_H, "\ue006+\ue022".ToString());
...
>>>>>>> d46cf8619665219cc163a7b28984ced59ed9470d
			...
			MyControllerHelper.AddControl(cX_SPACESHIP, MyControlsSpace.FAKE_MOVEMENT_H, "\ue005+\ue009");
			MyControllerHelper.AddControl(cX_SPACESHIP, MyControlsSpace.FAKE_MOVEMENT_V, "\ue005+\ue025");
		}

		private static void CreateCommonForJetpackAndShip(MyStringId context, bool invertYAxisCharacter, bool invertYAxisJetpackVehicle)
		{
			MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_LEFT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xneg, pressed: false);
			MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_RIGHT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xpos, pressed: false);
			MyControllerHelper.AddControl(context, MyControlsSpace.STRAFE_LEFT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xneg, pressed: true);
			MyControllerHelper.AddControl(context, MyControlsSpace.STRAFE_RIGHT, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.Xpos, pressed: true);
			if (invertYAxisJetpackVehicle)
			{
				MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_DOWN, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYneg, pressed: false);
				MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_UP, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYpos, pressed: false);
				MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_UP, MyJoystickButtonsEnum.J06, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.RotationYpos);
				MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_DOWN, MyJoystickButtonsEnum.J06, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.RotationYneg);
			}
			else
			{
				MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_UP, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYneg, pressed: false);
				MyControllerHelper.AddControl(context, MyControlsSpace.ROTATION_DOWN, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYpos, pressed: false);
				MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_UP, MyJoystickButtonsEnum.J06, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.RotationYneg);
				MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_DOWN, MyJoystickButtonsEnum.J06, MyJoystickButtonsEnum.J05, MyJoystickAxesEnum.RotationYpos);
			}
			MyControllerHelper.AddControl(context, MyControlsSpace.JUMP, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYneg);
			MyControllerHelper.AddControl(context, MyControlsSpace.CROUCH, MyJoystickButtonsEnum.J05, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationYpos);
			MyControllerHelper.AddControl(context, MyControlsSpace.ROLL_LEFT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXneg, pressed: false);
			MyControllerHelper.AddControl(context, MyControlsSpace.ROLL_RIGHT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXpos, pressed: false);
			MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_LEFT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXneg, pressed: true);
			MyControllerHelper.AddControl(context, MyControlsSpace.LOOK_RIGHT, MyJoystickButtonsEnum.J06, MyJoystickAxesEnum.RotationXpos, pressed: true);
		}
		...
		private static void CreateForSpectator(bool invertYAxisCharacter, bool invertYAxisJetpackVehicle)
		{
			...
			MyControllerHelper.AddControl(cX_SPECTATOR, MyControlsSpace.FAKE_RB_V, "\ue006+" + '\ue00a');
			MyControllerHelper.AddControl(cX_SPECTATOR, MyControlsSpace.FAKE_RB_H, "\ue006+" + '\ue00a');
