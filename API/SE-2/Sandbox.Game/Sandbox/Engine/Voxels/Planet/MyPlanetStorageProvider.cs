...
namespace Sandbox.Engine.Voxels.Planet
{
	...
	public class MyPlanetStorageProvider : IMyStorageDataProvider
	{
		...
		public MyVoxelMaterialDefinition GetMaterialAtPosition(ref Vector3 localPosition)
		{
			if (Closed)
			{
				return null;
		...
		/// When using the coefficient cache be sure to have it properly set up. (MyPlanetShapeProvider.PrepareCache())
		///
		/// This version provides extremely detailed data about a surface position and should be used for debugging only.
