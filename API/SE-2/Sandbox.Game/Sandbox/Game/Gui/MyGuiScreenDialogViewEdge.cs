...
namespace Sandbox.Game.Gui
{
	internal class MyGuiScreenDialogViewEdge : MyGuiScreenBase
	{
		...
		public override void RecreateControls(bool contructor)
		{
			...
			Controls.Add(new MyGuiControlLabel(new Vector2(0f, -0.1f), null, "Enter the number of winged-edge mesh edge to view", null, 0.8f, "Blue", MyGuiDrawAlignEnum.HORISONTAL_CENTER_AND_VERTICAL_CENTER));
		...
		{
			MyWingedEdgeMesh.DebugDrawEdgesAdd(Convert.ToInt32(m_textbox.Text));
			CloseScreen();
		}
