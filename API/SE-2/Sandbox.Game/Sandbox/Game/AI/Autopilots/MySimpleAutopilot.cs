...
=======
				m_gridIds = Enumerable.ToArray<long>(Enumerable.Select<MyGroups<MyCubeGrid, MyGridLogicalGroupData>.Node, long>((IEnumerable<MyGroups<MyCubeGrid, MyGridLogicalGroupData>.Node>)group.Nodes, (Func<MyGroups<MyCubeGrid, MyGridLogicalGroupData>.Node, long>)((MyGroups<MyCubeGrid, MyGridLogicalGroupData>.Node x) => x.NodeData.EntityId)));
>>>>>>> d46cf8619665219cc163a7b28984ced59ed9470d
				RegisterGridCallbacks();
			}
