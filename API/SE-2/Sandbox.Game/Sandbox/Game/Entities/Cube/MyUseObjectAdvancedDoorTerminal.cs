...
namespace Sandbox.Game.Entities.Cube
{
	...
	public class MyUseObjectAdvancedDoorTerminal : MyUseObjectBase
	{
		...
		public override void Use(UseActionEnum actionEnum, IMyEntity entity)
		{
			...
			MyRelationsBetweenPlayerAndBlock userRelationToOwner = Door.GetUserRelationToOwner(myCharacter.ControllerInfo.ControllingIdentityId);
			switch (actionEnum)
			{
			case UseActionEnum.Manipulate:
				...
				{
					Door.SetOpenRequest(!Door.Open, myCharacter.ControllerInfo.ControllingIdentityId);
				}
				break;
