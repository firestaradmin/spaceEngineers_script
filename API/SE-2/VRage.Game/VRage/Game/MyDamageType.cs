...
namespace VRage.Game
{
	public static class MyDamageType
	{
		...
		public static MyStringHash Debug = MyStringHash.GetOrCompute("Debug");

		public static MyStringHash Wolf = MyStringHash.GetOrCompute("Wolf");

		public static MyStringHash Spider = MyStringHash.GetOrCompute("Spider");

		public static MyStringHash Temperature = MyStringHash.GetOrCompute("Temperature");
	}
}
