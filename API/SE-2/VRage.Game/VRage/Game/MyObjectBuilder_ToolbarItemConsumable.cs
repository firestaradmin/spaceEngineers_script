...
namespace VRage.Game
{
	...
	public class MyObjectBuilder_ToolbarItemConsumable : MyObjectBuilder_ToolbarItemUsable
	{
		protected class VRage_Game_MyObjectBuilder_ToolbarItemConsumable_003C_003EDefinitionId_003C_003EAccessor : VRage_Game_MyObjectBuilder_ToolbarItemDefinition_003C_003EDefinitionId_003C_003EAccessor, IMemberAccessor<MyObjectBuilder_ToolbarItemConsumable, SerializableDefinitionId>
		{
			...
			public sealed override void Set(ref MyObjectBuilder_ToolbarItemConsumable owner, in SerializableDefinitionId value)
			{
				Set(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_ToolbarItemDefinition>(ref owner), in value);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public sealed override void Get(ref MyObjectBuilder_ToolbarItemConsumable owner, out SerializableDefinitionId value)
			{
				Get(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_ToolbarItemDefinition>(ref owner), out value);
			}
		}
		...
		{
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public sealed override void Set(ref MyObjectBuilder_ToolbarItemConsumable owner, in MyStringHash value)
			{
				Set(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_Base>(ref owner), in value);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public sealed override void Get(ref MyObjectBuilder_ToolbarItemConsumable owner, out MyStringHash value)
			{
				Get(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_Base>(ref owner), out value);
			}
		}
		...
		{
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public sealed override void Set(ref MyObjectBuilder_ToolbarItemConsumable owner, in string value)
			{
				Set(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_Base>(ref owner), in value);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public sealed override void Get(ref MyObjectBuilder_ToolbarItemConsumable owner, out string value)
			{
				Get(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_Base>(ref owner), out value);
			}
		}
		...
		protected class VRage_Game_MyObjectBuilder_ToolbarItemConsumable_003C_003EdefId_003C_003EAccessor : VRage_Game_ObjectBuilders_MyObjectBuilder_ToolbarItemUsable_003C_003EdefId_003C_003EAccessor, IMemberAccessor<MyObjectBuilder_ToolbarItemConsumable, SerializableDefinitionId>
		{
			...
			public sealed override void Set(ref MyObjectBuilder_ToolbarItemConsumable owner, in SerializableDefinitionId value)
			{
				Set(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_ToolbarItemUsable>(ref owner), in value);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public sealed override void Get(ref MyObjectBuilder_ToolbarItemConsumable owner, out SerializableDefinitionId value)
			{
				Get(ref System.Runtime.CompilerServices.Unsafe.As<MyObjectBuilder_ToolbarItemConsumable, MyObjectBuilder_ToolbarItemUsable>(ref owner), out value);
			}
		}
