...
{
	[MyUseObject("jukeboxPause")]
	public class MyUseObjectJukeboxPause : MyUseObjectBase
	{
		...
		public MyUseObjectJukeboxPause(IMyEntity owner, string dummyName, MyModelDummy dummyData, uint key)
		...
		public override MyActionDescription GetActionInfo(UseActionEnum actionEnum)
		{
			...
			if (actionEnum == UseActionEnum.Manipulate)
			{
				...
				result.Text = MySpaceTexts.NotificationHintJukeboxPlay;
