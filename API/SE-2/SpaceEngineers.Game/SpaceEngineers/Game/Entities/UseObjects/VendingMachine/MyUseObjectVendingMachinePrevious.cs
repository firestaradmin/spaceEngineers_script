...
namespace SpaceEngineers.Game.Entities.UseObjects.VendingMachine
{
	...
	public class MyUseObjectVendingMachinePrevious : MyUseObjectBase
	{
		...
		public MyUseObjectVendingMachinePrevious(IMyEntity owner, string dummyName, MyModelDummy dummyData, uint key)
		...
		public override MyActionDescription GetActionInfo(UseActionEnum actionEnum)
		{
			...
			case UseActionEnum.Manipulate:
				...
				result.Text = MySpaceTexts.NotificationHintPreviewsItem;
		...
		public override void Use(UseActionEnum actionEnum, IMyEntity userEntity)
		{
			...
			case UseActionEnum.Manipulate:
			{
				...
				{
					myVendingMachine.SelectPreviewsItem();
				}
				break;
			}
