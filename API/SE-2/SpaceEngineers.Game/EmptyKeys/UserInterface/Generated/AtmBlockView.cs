...
namespace EmptyKeys.UserInterface.Generated
{
	...
	public class AtmBlockView : UIRoot
	{
		...
		public AtmBlockView(int width, int height)
			: base(width, height)
		{
			Initialize();
		}
		...
		private void InitializeComponent()
		{
			...
			e_7.SetBinding(UIElement.DataContextProperty, binding4);
			e_8 = new Grid();
			...
			Binding binding5 = new Binding("InventoryItems");
			binding5.UseGeneratedBindings = true;
			e_9.SetBinding(ItemsControl.ItemsSourceProperty, binding5);
			...
			Binding binding6 = new Binding("CurrentInventoryVolume");
			binding6.UseGeneratedBindings = true;
			e_17.SetBinding(TextBlock.TextProperty, binding6);
			e_18 = new TextBlock();
			...
			Binding binding7 = new Binding("MaxInventoryVolume");
			binding7.UseGeneratedBindings = true;
			e_19.SetBinding(TextBlock.TextProperty, binding7);
			e_20 = new Grid();
			e_8.Children.Add(e_20);
			e_20.Name = "e_20";
			e_20.Margin = new Thickness(2f, 2f, 2f, 2f);
			RowDefinition item10 = new RowDefinition();
			e_20.RowDefinitions.Add(item10);
			RowDefinition item11 = new RowDefinition();
			e_20.RowDefinitions.Add(item11);
			RowDefinition item12 = new RowDefinition();
			e_20.RowDefinitions.Add(item12);
			RowDefinition item13 = new RowDefinition();
			e_20.RowDefinitions.Add(item13);
			...
			e_20.ColumnDefinitions.Add(item14);
			...
			Binding binding8 = new Binding("LocalPlayerCurrency");
			binding8.UseGeneratedBindings = true;
			e_22.SetBinding(TextBlock.TextProperty, binding8);
			e_23 = new Image();
			...
			Binding binding9 = new Binding("CurrencyIcon");
			binding9.UseGeneratedBindings = true;
			e_23.SetBinding(Image.SourceProperty, binding9);
			e_24 = new TextBlock();
			...
			Grid.SetRow(e_25, 1);
			Binding binding10 = new Binding("BalanceChangeValue");
			binding10.UseGeneratedBindings = true;
			e_25.SetBinding(NumericTextBox.ValueProperty, binding10);
			e_26 = new Image();
			e_20.Children.Add(e_26);
			e_26.Name = "e_26";
			e_26.Height = 20f;
			e_26.Margin = new Thickness(4f, 2f, 2f, 2f);
			...
			e_26.SetBinding(Image.SourceProperty, binding11);
			e_27 = new Border();
			e_20.Children.Add(e_27);
			e_27.Name = "e_27";
			e_27.Height = 2f;
			e_27.Margin = new Thickness(0f, 10f, 0f, 10f);
			e_27.Background = new SolidColorBrush(new ColorW(77, 99, 113, 255));
			Grid.SetRow(e_27, 2);
			Grid.SetColumnSpan(e_27, 3);
			e_28 = new Grid();
			e_20.Children.Add(e_28);
			e_28.Name = "e_28";
			e_28.Margin = new Thickness(0f, 0f, 0f, 30f);
			ColumnDefinition item15 = new ColumnDefinition();
			e_28.ColumnDefinitions.Add(item15);
			ColumnDefinition item16 = new ColumnDefinition();
			e_28.ColumnDefinitions.Add(item16);
			Grid.SetRow(e_28, 3);
			Grid.SetColumnSpan(e_28, 3);
			e_29 = new Button();
			e_28.Children.Add(e_29);
			e_29.Name = "e_29";
			e_29.Margin = new Thickness(0f, 5f, 5f, 5f);
			e_29.VerticalAlignment = VerticalAlignment.Center;
			e_29.TabIndex = 2;
			Binding binding12 = new Binding("DepositCommand");
			binding12.UseGeneratedBindings = true;
			e_29.SetBinding(Button.CommandProperty, binding12);
			e_29.SetResourceReference(ContentControl.ContentProperty, "FactionTerminal_Deposit_Currency");
			e_30 = new Button();
			...
			Binding binding13 = new Binding("WithdrawCommand");
			binding13.UseGeneratedBindings = true;
			e_30.SetBinding(Button.CommandProperty, binding13);
			e_30.SetResourceReference(ContentControl.ContentProperty, "FactionTerminal_Withdraw_Currency");
