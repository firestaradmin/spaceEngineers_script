...
namespace EmptyKeys.UserInterface.Generated
{
	...
	public class ActiveContractsView_Gamepad : UIRoot
	{
		...
		public ActiveContractsView_Gamepad()
		{
			Initialize();
		}
		...
		private void InitializeComponent()
		{
			...
			Binding binding4 = new Binding("AbandonCommand");
			...
			Binding binding5 = new Binding("RefreshActiveCommand");
			binding5.UseGeneratedBindings = true;
			gamepadBinding2.SetBinding(InputBinding.CommandProperty, binding5);
			e_6.InputBindings.Add(gamepadBinding2);
			gamepadBinding2.Parent = e_6;
			...
			rowDefinition11.Height = new GridLength(65f, GridUnitType.Pixel);
			...
			GamepadHelp.SetTargetName(e_7, "DataGridHelp");
			Binding binding6 = new Binding("ActiveContracts");
			binding6.UseGeneratedBindings = true;
			e_7.SetBinding(ItemsControl.ItemsSourceProperty, binding6);
			Binding binding7 = new Binding("SelectedActiveContractIndex");
			binding7.UseGeneratedBindings = true;
			e_7.SetBinding(Selector.SelectedIndexProperty, binding7);
			Binding binding8 = new Binding("SelectedActiveContract");
			binding8.UseGeneratedBindings = true;
			e_7.SetBinding(Selector.SelectedItemProperty, binding8);
			...
			Grid.SetRow(e_8, 0);
			Binding binding9 = new Binding("IsNoActiveContractVisible");
			binding9.UseGeneratedBindings = true;
			e_8.SetBinding(UIElement.VisibilityProperty, binding9);
			e_9 = new TextBlock();
			...
			Binding binding10 = new Binding("SelectedActiveContract");
			binding10.UseGeneratedBindings = true;
			e_11.SetBinding(UIElement.DataContextProperty, binding10);
			Binding binding11 = new Binding("SelectedActiveContract");
			binding11.UseGeneratedBindings = true;
			e_11.SetBinding(ContentPresenter.ContentProperty, binding11);
			e_12 = new Border();
			e_6.Children.Add(e_12);
			e_12.Name = "e_12";
			e_12.Height = 2f;
			e_12.Margin = new Thickness(0f, 10f, 0f, 0f);
			e_12.Background = new SolidColorBrush(new ColorW(77, 99, 113, 255));
			Grid.SetRow(e_12, 1);
			Grid.SetColumnSpan(e_12, 2);
			DataGridHelp = new Grid();
			e_6.Children.Add(DataGridHelp);
			DataGridHelp.Name = "DataGridHelp";
			DataGridHelp.VerticalAlignment = VerticalAlignment.Center;
			ColumnDefinition columnDefinition6 = new ColumnDefinition();
			columnDefinition6.Width = new GridLength(1f, GridUnitType.Auto);
			DataGridHelp.ColumnDefinitions.Add(columnDefinition6);
			ColumnDefinition columnDefinition7 = new ColumnDefinition();
			columnDefinition7.Width = new GridLength(1f, GridUnitType.Auto);
			DataGridHelp.ColumnDefinitions.Add(columnDefinition7);
			ColumnDefinition columnDefinition8 = new ColumnDefinition();
			columnDefinition8.Width = new GridLength(1f, GridUnitType.Auto);
			DataGridHelp.ColumnDefinitions.Add(columnDefinition8);
			ColumnDefinition item4 = new ColumnDefinition();
			DataGridHelp.ColumnDefinitions.Add(item4);
			Grid.SetRow(DataGridHelp, 2);
			Grid.SetColumnSpan(DataGridHelp, 2);
			e_13 = new TextBlock();
			DataGridHelp.Children.Add(e_13);
			e_13.Name = "e_13";
			...
			e_13.SetResourceReference(TextBlock.TextProperty, "ActiveContractsScreen_Help_Abandon");
			e_14 = new TextBlock();
			DataGridHelp.Children.Add(e_14);
			e_14.Name = "e_14";
			e_14.Margin = new Thickness(10f, 0f, 5f, 0f);
			e_14.HorizontalAlignment = HorizontalAlignment.Center;
			e_14.VerticalAlignment = VerticalAlignment.Center;
			Grid.SetColumn(e_14, 1);
			e_14.SetResourceReference(TextBlock.TextProperty, "ActiveContractsScreen_Help_Refresh");
			e_15 = new TextBlock();
			DataGridHelp.Children.Add(e_15);
			e_15.Name = "e_15";
			e_15.Margin = new Thickness(10f, 0f, 5f, 0f);
			e_15.HorizontalAlignment = HorizontalAlignment.Center;
			e_15.VerticalAlignment = VerticalAlignment.Center;
			Grid.SetColumn(e_15, 2);
			e_15.SetResourceReference(TextBlock.TextProperty, "Gamepad_Help_Back");
