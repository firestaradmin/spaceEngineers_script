namespace VRageRender.Import
{
	public static class MyImporterConstants
	{
		...
		public const string TAG_FBXHASHSTRING = "FBXHash";

		public const string TAG_HKTHASHSTRING = "HKTHash";

		public const string TAG_XMLHASHSTRING = "XMLHash";

		public const string TAG_MODEL_FRACTURES = "ModelFractures";

		public const string TAG_GEOMETRY_DATA_ASSET = "GeometryDataAsset";

		public const string TAG_IS_SKINNED = "IsSkinned";
	}
}
